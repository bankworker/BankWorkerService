...
public class BranchArchiveDetailController {
    ...
    @RequestMapping(value = "/fuzzy/{bankCode}/{branchCode}/{fuzzyContent}", method = RequestMethod.GET)
    public UnifiedResponse findList(@PathVariable("bankCode") String bankCode,
                                    @PathVariable("branchCode") String branchCode,
                                    @PathVariable("fuzzyContent") String fuzzyContent){
        return serviceImpl.findList4Fuzzy(bankCode, branchCode, fuzzyContent);
    }
